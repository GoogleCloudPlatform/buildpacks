...
func TestAcceptanceRuby(t *testing.T) {
	...
	testCases := []acceptance.Test{
		...
		},
		{
			...
			App:                        "simple",
			Path:                       "/version?want=3.4.0",
			Env:                        []string{"GOOGLE_RUNTIME_VERSION=3.4.0"},
			MustUse:                    []string{rubyRuntime, rubyBundle, entrypoint},
			VersionInclusionConstraint: "< 4.0.0",
		},
		{
		...
		},
		{
			...
			Env:                        []string{"GOOGLE_RUNTIME_VERSION=3.4.0", "GOOGLE_ENTRYPOINT=bundle exec ruby myapp.rb"},
			MustUse:                    []string{rubyRuntime, rubyBundle, entrypoint},
		...
		{
			Name:                       "entrypoint_from_procfile_custom_ruby4",
			App:                        "simple_ruby4",
			SkipStacks:                 []string{"google.22", "google.min.22", "google.gae.22"},
			Path:                       "/custom",
			Entrypoint:                 "custom", // Must match the non-web process in Procfile.
		...
		{
			Name:                       "entrypoint_from_env_ruby4",
			App:                        "simple_ruby4",
			SkipStacks:                 []string{"google.22", "google.min.22", "google.gae.22"},
			Path:                       "/custom",
			Env:                        []string{"GOOGLE_ENTRYPOINT=ruby custom.rb", "GOOGLE_RUNTIME_VERSION=4.0.0"},
			MustUse:                    []string{rubyRuntime, rubyBundle, entrypoint},
			VersionInclusionConstraint: ">= 4.0.0",
		},
		{
			Name:                       "entrypoint_with_env_var_ruby4",
			App:                        "simple_ruby4",
			SkipStacks:                 []string{"google.22", "google.min.22", "google.gae.22"},
			Path:                       "/env?want=bar",
			Env:                        []string{"GOOGLE_ENTRYPOINT=FOO=bar ruby main.rb", "GOOGLE_RUNTIME_VERSION=4.0.0"},
			MustUse:                    []string{rubyRuntime, rubyBundle, entrypoint},
			VersionInclusionConstraint: ">= 4.0.0",
		},
		{
			Name:                       "GOOGLE_RUNTIME_VERSION_env_ruby4",
			App:                        "simple_ruby4",
			SkipStacks:                 []string{"google.22", "google.min.22", "google.gae.22"},
			Path:                       "/version?want=4.0.0",
			Env:                        []string{"GOOGLE_RUNTIME_VERSION=4.0.0"},
			MustUse:                    []string{rubyRuntime, rubyBundle, entrypoint},
			VersionInclusionConstraint: ">= 4.0.0",
		},
		{
			...
			App:                        "rails_ruby4",
			SkipStacks:                 []string{"google.22", "google.min.22", "google.gae.22"},
			Env:                        []string{"GOOGLE_RUNTIME_VERSION=4.0.0", "GOOGLE_ENTRYPOINT=bundle exec ruby myapp-custom.rb"},
			MustUse:                    []string{rubyRuntime, rubyRails, rubyBundle, entrypoint, nodeRuntime},
			EnableCacheTest:            true,
			VersionInclusionConstraint: ">= 4.0.0",
		},
		{
			Name:                       "rails_precompiled_ruby4",
			App:                        "rails_precompiled_ruby4",
			SkipStacks:                 []string{"google.22", "google.min.22", "google.gae.22"},
			Env:                        []string{"GOOGLE_RUNTIME_VERSION=4.0.0", "GOOGLE_ENTRYPOINT=bundle exec ruby myapp.rb"},
			MustUse:                    []string{rubyRuntime, rubyBundle, entrypoint},
			MustNotUse:                 []string{rubyRails, nodeRuntime},
			VersionInclusionConstraint: ">= 4.0.0",
		},
		{
			Name:                       "ruby_native_extensions_ruby4",
			App:                        "native_extensions_ruby4",
			SkipStacks:                 []string{"google.22", "google.min.22", "google.gae.22"},
			MustUse:                    []string{rubyRuntime, rubyBundle, entrypoint},
			EnableCacheTest:            false,
			Env:                        []string{"GOOGLE_RUNTIME_VERSION=4.0.0"},
...
func TestFailuresRuby(t *testing.T) {
	...
	testCases := []acceptance.FailureTest{
		...
		{
			Name:                       "missing_entrypoint_ruby4",
			App:                        "missing_entrypoint_ruby4",
			MustMatch:                  `for Ruby, an entrypoint must be manually set, either with "GOOGLE_ENTRYPOINT" env var or by creating a "Procfile" file`,
			VersionInclusionConstraint: ">= 4.0.0",
		},
	}
