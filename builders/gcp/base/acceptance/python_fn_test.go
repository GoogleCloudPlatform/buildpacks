	...
	testCases := []acceptance.Test{
		{
			...
			Path:       "/testFunction",
			Env:        []string{"GOOGLE_FUNCTION_TARGET=testFunction", "GOOGLE_PYTHON_VERSION=3.12"},
		...
		},
		{
			...
			App:        "custom_file",
			Path:       "/testFunction",
			Env:        []string{"GOOGLE_FUNCTION_TARGET=testFunction", "GOOGLE_FUNCTION_SOURCE=func.py", "GOOGLE_PYTHON_VERSION=3.12"},
			MustUse:    []string{pythonRuntime, pythonFF, pythonPIP},
			MustNotUse: []string{entrypoint},
		},
		{
