...
func TestAcceptancePython(t *testing.T) {
	...
	testCases := []acceptance.Test{
		...
		{
			Name:                       "no_fastapi_smart_default_entrypoint_for_3.13_and_below_app_py",
			App:                        "fastapi_uvicorn_app_py",
			Env:                        []string{"X_GOOGLE_PYTHON_SMART_DEFAULTS=true"},
			MustUse:                    []string{pythonRuntime, pythonPIP, pythonMissingEntrypoint},
			VersionInclusionConstraint: "<3.13.0",
		...
		{
			Name:                       "fastapi_standard_smart_default_entrypoint_for_3.13_and_below_app_py",
			App:                        "fastapi_standard_app_py",
			Env:                        []string{"X_GOOGLE_PYTHON_SMART_DEFAULTS=true"},
			MustUse:                    []string{pythonRuntime, pythonPIP, pythonMissingEntrypoint},
			VersionInclusionConstraint: "<3.13.0",
		...
		{
			Name:                       "pyproject_and_requirements_python313_and_below",
		...
		{
			Name:                       "pyproject_and_requirements_python314_and_above",
			App:                        "pyproject_and_requirements",
			Env:                        []string{"X_GOOGLE_RELEASE_TRACK=ALPHA", "X_GOOGLE_PYTHON_SMART_DEFAULTS=true"},
			MustUse:                    []string{pythonRuntime, pythonUV, pythonMissingEntrypoint},
			VersionInclusionConstraint: ">= 3.14.0",
