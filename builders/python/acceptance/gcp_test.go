...
func TestAcceptancePython(t *testing.T) {
	...
	testCases := []acceptance.Test{
		...
		},
		{
			...
			App:                        "simple_new",
			Path:                       "/custom",
			Env:                        []string{"GOOGLE_ENTRYPOINT=gunicorn -b :8080 custom:app", "GOOGLE_PYTHON_PACKAGE_MANAGER=uv", "X_GOOGLE_RELEASE_TRACK=BETA"},
			MustUse:                    []string{pythonRuntime, pythonUV, entrypoint},
			VersionInclusionConstraint: ">= 3.8.0",
		},
		{
			...
			App:                        "simple_new",
			Path:                       "/custom",
			Env:                        []string{"GOOGLE_ENTRYPOINT=gunicorn -b :8080 custom:app", "GOOGLE_PYTHON_PACKAGE_MANAGER=pip", "X_GOOGLE_RELEASE_TRACK=BETA"},
			MustUse:                    []string{pythonRuntime, pythonPIP, entrypoint},
			VersionInclusionConstraint: ">= 3.8.0",
		},
		{
		...
		},
		{
			...
			App:                        "simple_new",
			Path:                       "/env?want=bar",
			Env:                        []string{"GOOGLE_ENTRYPOINT=FOO=bar gunicorn -b :8080 main:app", "GOOGLE_PYTHON_PACKAGE_MANAGER=pip", "X_GOOGLE_RELEASE_TRACK=BETA"},
			MustUse:                    []string{pythonRuntime, pythonPIP, entrypoint},
			VersionInclusionConstraint: ">= 3.8.0",
		},
		{
		...
		},
		{
			...
			App:                        "scripts_new",
			Env:                        []string{"GOOGLE_ENTRYPOINT=gunicorn -b :8080 main:app", "GOOGLE_PYTHON_PACKAGE_MANAGER=uv", "X_GOOGLE_RELEASE_TRACK=BETA"},
			MustUse:                    []string{pythonRuntime, pythonUV, entrypoint},
			VersionInclusionConstraint: ">= 3.8.0",
		},
		{
		...
		},
		{
			...
			App:                        "requirements_vendored_dependencies",
			Env:                        []string{"GOOGLE_VENDOR_PIP_DEPENDENCIES=package", "X_GOOGLE_RELEASE_TRACK=BETA", "GOOGLE_PYTHON_PACKAGE_MANAGER=uv"},
			MustUse:                    []string{pythonRuntime, pythonUV, entrypoint},
			VersionInclusionConstraint: ">= 3.10.0",
		},
		{
