...
func TestFailures(t *testing.T) {
	...
	testCases := []acceptance.FailureTest{
		...
		},
		{
			...
			Env:       []string{"GOOGLE_FUNCTION_TARGET=Func"},
			Setup:     vendorSetup,
			MustMatch: "vendored dependencies must include \"github.com/GoogleCloudPlatform/functions-framework-go/funcframework\"; if your function does not depend on the module, please add a blank import: `_ \"github.com/GoogleCloudPlatform/functions-framework-go/funcframework\"`",
		},
	}
