...
machine europe-north2-python.pkg.dev login oauth2accesstoken password token
...
machine northamerica-south1-python.pkg.dev login oauth2accesstoken password token
