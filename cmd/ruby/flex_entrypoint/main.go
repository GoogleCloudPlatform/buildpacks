...
import googlecloudplatform.buildpacks.cmd.ruby.flex_entrypoint.lib as lib
from googlecloudplatform.buildpacks.pkg.gcpbuildpack import main as gcp_main

if __name__ == "__main__":
    gcp_main(detect_fn=lib.detect_fn, build_fn=lib.build_fn)
