...
from googlecloudplatform.buildpacks.cmd.dotnet.flex import lib
import googlecloudplatform.buildpacks.pkg.gcpbuildpack

def main():
    gcpbuildpack.run_buildpack(detect_fn=lib.detect, build_fn=lib.build)
